...
<link href="https://fonts.googleapis.com/css2?family=Roboto:wght@300;400&display=swap" rel="stylesheet">
    ...
    <nav class="navbar navbar-expand-lg p-4   navbar-light bg-light">
        ...
        <a class="navbar-brand logo" href="#" > Hussam </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto mr-5">
            ...
            <li class="nav-item">
              <a class="nav-link nav-link-hover" href="#skills"><i class="mr-1 fa fa-star nav-icon " ></i> Technical Skills</a>
            </li>
      ...
      <div class="intro">
        ...
        <div class="p-4 ml-4 ">
          <div class="row">
            <div class="col-sm-8 p-4 wow wow animate__slideInDown">
              
              <h3 class="" data-in-effect="rollIn">Hello There ,<span class="hussamadil">Hussam Adil</span> </h3>
              <p class="Im-an-full-stack   mt-3"   data-wow-duration="1s">
                
                I'm a Full Stack Web Developer. based in Sudan 🇸🇩.

              I enjoy creating things that live on the internet, whether that be websites, applications, or anything in between.
              
              I graduated from <a  target="_blank" class="university-link text-dark" href="https://www.siu-sd.com/">Sudan international University</a>.
              <div class="mt-3 "   data-wow-duration="1s" >
                <a href="#contact-me" class="contact-mebtn btn btn-warning" style="background:#d2f4f6;border:0"><i class="fa fa-envelope-open-o"> </i> Contact Me</a>
            </div> 
            </p>
            </div>
            <div class="col-sm-4">
              <img alt="Hussam Adil "  class="text-center  personal-image   wow animate__fadeInDown" data-wow-delay="1s" src="https://i.ibb.co/yBz2PF6/Project-Drawing-1731238579-1.png">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#d2f4f6" fill-opacity="1" d="M0,32L288,192L576,224L864,224L1152,320L1440,256L1440,320L1152,320L864,320L576,320L288,320L0,320Z"></path></svg>    <div style="background: #d2f4f6">
      <div class=" container p-4" id="education">
       <div class="mb-3  " style="background: #d2f4f6">
          <span class="h3 mb-3  section-title" style="background:#fff;color:#333"><i class="nav-icon mr-1 fa fa-book" aria-hidden="true"></i> Education</span>
     ...
     <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#d2f4f6" fill-opacity="1" d="M0,32L288,192L576,224L864,224L1152,320L1440,256L1440,0L1152,0L864,0L576,0L288,0L0,0Z"></path></svg> <!-- end my-skills -->
       <!-- end  intro-->
            ...
            <div class="work mt-2   p-2" id="work">
              <div class=" p-4 container">
                <div class="mb-3">
                  <span class="h3 section-title  "  ><i class="nav-icon mr-1 fa fa-briefcase" aria-hidden="true"></i> Work</span> 
